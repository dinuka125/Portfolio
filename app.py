...
with st.container():
    ...
    with col1:
        ...
        Previously I completed my research internship under the supervision of [Prof. Chinthaka Premachandra](https://shibaura.pure.elsevier.com/en/persons/chinthaka-premachandra) at [Department of Electronic Engineering, Shibaura Institue of Technology, Koto ku, Japan.](https://www.shibaura-it.ac.jp/en/academics/engineering/ele.html)
